...
total_points %>%
  ...
  row_spec(0, background = "#FFFFFF", color = "#000000",bold=T) %>%  # White header
  row_spec(1:4, background = "#8AD1F3") %>%  # Champions League
  row_spec(5:6, background = "#EEA256") %>%  # Orange
  row_spec(7, background = "#E1D625") %>%  # Orange
